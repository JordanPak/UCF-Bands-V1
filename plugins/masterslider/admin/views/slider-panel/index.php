...
<script type="text/x-handlebars">
    ...
    {{else}}
        ...
        <div class="msp-shortcode-cont">
            <span><?php _e('Shortcode :', MSWP_TEXT_DOMAIN); ?> </span><span class="msp-shortcode-box">[masterslider id={{sliderId}}]</span>
            <span><?php _e('PHP function :', MSWP_TEXT_DOMAIN); ?> </span><span class="msp-shortcode-box">&lt;?php masterslider({{sliderId}}); ?&gt;</span>
        </div>
    ...
    <ul class="tabs-content">
        <li id="layer-content">
            <div class="msp-metabox-row">
                ...
                <h4><?php _e('Link layer', MSWP_TEXT_DOMAIN); ?></h4>
                <div class="msp-metabox-indented">
