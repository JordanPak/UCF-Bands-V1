...
function msp_masterslider_layer_shortcode( $atts, $content = null ) {
	...
	if( 'hotspot' !== $type ) {
	 ...
	 $data_show_ease = 'linar' === $show_ease ? '': 'data-ease="'.$show_ease.'"';
	...
	$common_attrs = sprintf( '%s %s %s %s %s %s', $data_parallax, $data_type, $data_resize, $data_align, $data_stay_hover, $data_tp_width );
