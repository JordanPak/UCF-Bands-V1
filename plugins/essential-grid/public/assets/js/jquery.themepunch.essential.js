			...
			****************************************/
			jQuery('.esg-filter-wrapper').each(function() {
				...
				if (efw.hasClass("dropdownstyle")) {
					...
					efw.append('<div class="esg-selected-filterbutton"><span>Filter DropDown</span><i class="eg-icon-down-open"></i></div>');
					
					efw.find('.esg-selected-filterbutton').click(function() {
						var efw = jQuery(this).closest('.esg-filter-wrapper');
						efw.find('.esg-dropdown-wrapper').slideDown(200);
					});
					...
					efw.hover(function() {
						...
						var efw = jQuery(this).closest('.esg-filter-wrapper');
						efw.find('.esg-dropdown-wrapper').slideUp(200);
			...
			************************************************/
			...
			container.on('itemsinposition',function() {
				...
				if (opt.maxheight>0 && opt.maxheight<9999999999) {
					...
					TweenLite.to(ul,heightspeed,{force3D:true,height:newheight,ease:Power3.easeInOut});
					TweenLite.to(esgo,heightspeed,{force3D:true,height:newheight,ease:Power3.easeInOut});
